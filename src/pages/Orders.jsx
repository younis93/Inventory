                                    ...
                                    <tr key={order._id} className="hover:bg-slate-50/50 dark:hover:bg-slate-700/50 transition-colors">
                                        ...
                                        <td className="px-6 py-4 text-end border-s dark:border-slate-700">
                                            <div className="flex items-center justify-end gap-2">
                                                ...
                                                <button onClick={() => triggerPDFPrint(order)} className="p-2 text-slate-400 hover:text-indigo-600 hover:bg-indigo-50 dark:hover:bg-indigo-900/20 rounded-lg" title="PDF Invoice">
                            ...
                            <div key={order._id} className="bg-white dark:bg-slate-800 rounded-2xl border border-slate-100 dark:border-slate-700 p-4 flex items-start justify-between">
                                <div className="flex-1 min-w-0">
                                    ...
                                    <div className="flex items-center justify-end gap-1 mt-3 pt-3 border-t border-slate-50 dark:border-slate-700/50">
                                        <button onClick={() => handleViewOrder(order)} className="p-2 text-slate-400 hover:text-[var(--brand-color)] hover:bg-slate-100 dark:hover:bg-slate-700/50 rounded-lg transition-all" title="View Order">
                                            <Eye className="w-5 h-5" />
                                        </button>
                                        <button onClick={() => handleEditOrder(order)} className="p-2 text-slate-400 hover:text-[var(--brand-color)] hover:bg-slate-100 dark:hover:bg-slate-700/50 rounded-lg transition-all" title="Edit Order">
                                            <Edit className="w-5 h-5" />
                                        </button>
                                        <button onClick={() => triggerPDFPrint(order)} className="p-2 text-slate-400 hover:text-blue-600 hover:bg-blue-50 dark:hover:bg-blue-900/20 rounded-lg transition-all" title="PDF Invoice">
                                            <Download className="w-5 h-5" />
                                        </button>
                    ...
                    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-slate-900/40 backdrop-blur-md p-4 animate-in fade-in duration-300">
                        <div className="bg-white dark:bg-slate-800 rounded-[32px] shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-hidden flex flex-col relative">
                            ...
                            <div className="px-8 py-6 border-t border-slate-100 dark:border-slate-700 flex justify-end items-center gap-3 bg-white dark:bg-slate-800">
                                ...
                                <button
                                    onClick={() => triggerPDFPrint(viewingOrder)}
